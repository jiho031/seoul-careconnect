...
public class MyHomeRentalClient extends AbstractMyHomeClient {

    public MyHomeRentalClient(
            ...
            @Value("${app.external.data-go.myhome.rental-url}") String url,
